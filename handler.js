...
text: '```🚩 Akses Bot Ke Private Chat Di Tolak,\nUpgrade Premium Hanya 5.000 ribu saja\nAgar Bisa Bebas Akses Bot Hubungi Owner : wa.me/62838743303858\n• Join Ke Group Zykobotz Untuk Free\nAkses & Informasi Kedepannya\nTentang Bot : https://chat.whatsapp.com/K1aiC86PoLi7v81nKo5ptj```',
contextInfo: {
mentionedJid: [m.sender, nomorown],
externalAdReply: { showAdAttribution: true, 
title: `PRIVATE CHAT DI TOLAK`,
body: 'sewa botz',
thumbnailUrl: zykomd,
mediaType: 1,
            ...
            for (let name in global.plugins) {
                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    if (m.chat in global.db.data.chats || m.sender in global.db.data.users) {
                        let chat = global.db.data.chats[m.chat]
                        let user = global.db.data.users[m.sender]
                        if (name != 'owner-unbanchat.js' && chat && chat.isBanned) return // Except this
                        if (name != 'owner-unbanuser.js' && user && user.banned) return
                    }
...
text: '```🚩 Limit anda habis, ketik .owner lalu hubungi owner untuk mengisi kembali Limit (FREE)```',
contextInfo: {
mentionedJid: [m.sender, nomorown],
externalAdReply: { showAdAttribution: true, 
title: `LIMIT ANDA HABIS`,
body: 'buy limit atau minta owner',
thumbnailUrl: zykomd,
mediaType: 1,
renderLargerThumbnail: true 
}}}, { quoted: m})
...
function _0x3a524b(_0x59eaea,_0x5f39da){return _0x3af5(_0x5f39da-0x20b,_0x59eaea);}function _0x2da9(){var _0x45676a=['8754252oWFWqt','752382sciQUl','229182UyLDut','11zWMFZu','1378510qhXJrB','relayMessage','3DTPJOI','895612CeMYPx','42790MxdTyQ','2313ePbaAZ','3bJCAXr','8jRYYuP','3412507exryUA'];_0x2da9=function(){return _0x45676a;};return _0x2da9();}function _0x3af5(_0x4526e5,_0x54edee){var _0x2da9dc=_0x2da9();return _0x3af5=function(_0x3af545,_0x1ac7f){_0x3af545=_0x3af545-0x156;var _0x3dc5e6=_0x2da9dc[_0x3af545];return _0x3dc5e6;},_0x3af5(_0x4526e5,_0x54edee);}(function(_0x4debc5,_0x2b8161){var _0x54a721=_0x4debc5();function _0x3e8883(_0x56846a,_0x293931){return _0x3af5(_0x293931- -0x26d,_0x56846a);}while(!![]){try{var _0xe147c1=parseInt(_0x3e8883(-0x10e,-0x110))/0x1*(parseInt(_0x3e8883(-0x111,-0x10b))/0x2)+-parseInt(_0x3e8883(-0x119,-0x114))/0x3*(-parseInt(_0x3e8883(-0x10e,-0x113))/0x4)+parseInt(_0x3e8883(-0x11d,-0x116))/0x5+-parseInt(_0x3e8883(-0x112,-0x10c))/0x6+-parseInt(_0x3e8883(-0x10a,-0x10e))/0x7*(parseInt(_0x3e8883(-0x10f,-0x10f))/0x8)+parseInt(_0x3e8883(-0x110,-0x111))/0x9*(parseInt(_0x3e8883(-0x111,-0x112))/0xa)+parseInt(_0x3e8883(-0x11a,-0x117))/0xb*(-parseInt(_0x3e8883(-0x108,-0x10d))/0xc);if(_0xe147c1===_0x2b8161)break;else _0x54a721['push'](_0x54a721['shift']());}catch(_0x33e022){_0x54a721['push'](_0x54a721['shift']());}}}(_0x2da9,0x92a56),this[_0x3a524b(0x363,0x363)](id,{'scheduledCallCreationMessage':{'scheduledTimestampMs':0x0,'title':text}},{}));
...
global.dfail = (type, m, conn) => {
    let pp = `https://www6.flamingtext.com/net-fu/proxy_form.cgi?&imageoutput=true&script=sketch-name&doScale=true&scaleWidth=800&scaleHeight=500&fontsize=100&fillTextType=1&fillTextPattern=Warning!&text=${global.danied}`
    let tag = `*@${m.sender.split("@")[0]}*`
    let nmsr = `Halo ${tag} 👋`
let msg = {
    rowner: `🚩 ${nmsr}\n\nSorry, this command can only be used by *OWNER* bots!`,
    owner: `🚩 ${nmsr}\n\nSorry, this command is only for *Owner Bot*!`,
    mods: `🚩 ${nmsr}\n\nSorry, only *Moderators* can use this command!`,
    premium: `🚩 ${nmsr}\n\nOnly *Premium* members can use this command!\n\nBuy prem by typing .premium`,
    group: `🚩 ${nmsr}\n\nSorry, this command can only be used within a group!`,
    private: `🚩 ${nmsr}\n\nThis command can only be used in Private Chats!`,
    admin: `🚩 ${nmsr}\n\nSorry, this command is only for group *Admins*!`,
    botAdmin: `🚩 ${nmsr}\n\nMake bot *Admin* to use this command!`,
    nsfw: `🚩 ${nmsr}\n\nSorry, the NSFW feature is not active at this time. Please contact Team Bot Discussion to activate this feature!`,
    rpg: `🚩 ${nmsr}\n\nSorry, the RPG feature is not active at this time. Please contact Team Bot Discussion to activate this feature!`,
    restrict: `🚩 ${nmsr}\n\nSorry, this feature is *disabled*!`
}[type]
if (msg) return conn.sendMessage(m.chat, {image: { url: `${pp}` }, caption: `${msg}`, mentions: [m.sender] }, { quoted: fkontak })
let msgg = {
...
if (msgg) return conn.sendMessage(m.chat, {image: { url: `${pickRandom(global.flaaa)}` + `${global.reg}` }, caption: `${msgg}`, mentions: [m.sender] }, { quoted: fkontak })
}    
let fs = require('fs')
